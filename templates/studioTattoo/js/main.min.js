...
}([function(e, t, n) { $(window).on("load", (function() { n(1), n(2), n(3) })) }, function(e, t, n) {
    "use strict";
    var r = $(".btn-collapse"),
        o = $(".collapse-menu");
    r.length && r.click((function(e) {
        e.preventDefault();
        for (var t = $(this).attr("data-target"), n = 0; n <= o.length; n++) $(o[n]).hasClass("in") && $(o[n]).removeClass("in");
        for (var a = 0; a <= r.length; a++) $(r[a]).attr("aria-expanded") && $(r[a]).attr("aria-expanded", !1);
        $(this).attr("aria-expanded", "true" === $(this).attr("aria-expanded") ? "false" : "true"), $(t).collapse("toggle")
    }))
