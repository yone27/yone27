...
if (carousel.length) {
    let itemCarousel = $('.carousel .item'),
    ...
    //ajustando las imagenes del background del carousel
    $(itemCarousel).ready(function ($) {
        function carouselResize() {
            if (carousel.hasClass('full-screen')) {
                carousel = $('.carousel.full-screen')
        ...
        // Si la ventana cambia de tamaño reformateo el slide
